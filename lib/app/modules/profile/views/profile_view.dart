...
class ProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // print('nama' + "${pageC.isLoading.value}");
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
      ...
      body: Obx(() => profileC.isLoading.value
          ? Center(
                      ...
                      child: Column(
                        children: [
                          ...
                          TextField(
                            readOnly: true,
                            decoration: InputDecoration(
                                label: Text("${profileC.jabatan.value}"),
                                labelStyle: TextStyle(color: Colors.black),
                                border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(100)),
                                focusedBorder: OutlineInputBorder(
                          ...
                          TextField(
                            readOnly: true,
                            decoration: InputDecoration(
                                label: Text("${profileC.email.value}"),
                                labelStyle: TextStyle(color: Colors.black),
                                border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(100)),
                                focusedBorder: OutlineInputBorder(
